...
export default function CartPage() {
  ...
  if (resolvedLines.length === 0) {
    return (
      <Container className="flex flex-col items-center py-24 text-center">
        ...
        <h1 className="mt-4 font-serif text-2xl font-semibold text-primary-950">Your cart is empty</h1>
        <p className="mt-2 text-primary-800/70">Browse the marketplace to find plants and trees you&apos;ll love.</p>
  ...
  return (
    <Container className="py-14">
      <h1 className="font-serif text-3xl font-semibold text-primary-950">Your Cart</h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-3">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-primary-800/70">{formatSom(product.price)}</p>
                </div>
        ...
        <div className="h-fit rounded-2xl border border-primary-100 bg-primary-50/60 p-6">
          ...
          <div className="mt-4 flex items-center justify-between text-sm">
            <span className="text-primary-800/70">Subtotal</span>
            <span className="font-medium text-primary-950">{formatSom(subtotal)}</span>
          </div>
          <p className="mt-2 text-xs text-primary-800/60">Delivery cost calculated at checkout.</p>
